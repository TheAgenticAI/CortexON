...
def register_tools_for_main_mcp_server(websocket: WebSocket, port=None) -> None:
    ...
    tool_names = ["plan_task", "code_task", "web_surf_task", "planner_agent_update", "deep_research_task"]
    ...
    tool_definitions = {
        ...
        "deep_research_task": (deep_research_task, "Assigns deep research tasks to the deep research agent for comprehensive research on any topic")
    }
